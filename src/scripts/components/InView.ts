...
export class InView extends Component<InViewData> {
	...
	public constructor(el: HTMLElement, data: InViewData) {
		...
		if (!isSupported()) {
			// @TODO: use ComponentInitializationError
			throw new Error('InView component not supported. Add IntersectionObserver polyfill.')
		}
